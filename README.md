...
- Local simulator video stream over browser-native WebRTC H.264, H.264 WebSocket, or direct HTTP MJPEG fallback
...
fall back to H.264 over WebSocket, then to the daemon's direct MJPEG stream and
