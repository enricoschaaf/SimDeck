...
export type SimDeckSession = {
    ...
    tapElement(udid: string, selector: ElementSelector, options?: TapOptions): Promise<void>;
    ...
    query(udid: string, selector: ElementSelector, options?: QueryOptions): Promise<unknown[]>;
    assert(udid: string, selector: ElementSelector, options?: QueryOptions): Promise<unknown>;
    waitFor(udid: string, selector: ElementSelector, options?: QueryOptions & {
        timeoutMs?: number;
        pollMs?: number;
    }): Promise<unknown>;
    batch(udid: string, steps: unknown[], continueOnError?: boolean): Promise<unknown>;
