...
pub struct ClientStreamStats {
    ...
    pub h264_parse_failures: Option<u64>,
    pub h264_socket_bytes: Option<u64>,
    pub h264_socket_messages: Option<u64>,
    pub h264_socket_message_type: Option<String>,
    pub packets_lost: Option<u64>,
    pub presentation_dropped_frames: Option<u64>,
    pub ice_restarts: Option<u64>,
    pub ice_restart_reason: Option<String>,
...
mod tests {
    ...
    fn stats(client_id: &str, kind: &str, timestamp_ms: Option<f64>) -> ClientStreamStats {
        ClientStreamStats {
            ...
            dropped_frames: None,
            h264_parse_failures: None,
            h264_socket_bytes: None,
            h264_socket_messages: None,
            h264_socket_message_type: None,
            packets_lost: None,
            presentation_dropped_frames: None,
            ice_restarts: None,
            ice_restart_reason: None,
            reconnects: None,
